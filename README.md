...
| 原文深读�?Deep Insight | Pro Terminal 深度追问 |
|:---:|:---:|
...
| 市场痛点 | Truth Decoder 的回�?|
| :--- | :--- |
| **信息过载**：读完通稿仍不知输�?| [cite_start]**剥离粉饰**：直接拆解「表层叙�?�?机制 �?代价�?[cite: 9] |
| **逻辑缺失**：摘要丢掉了因果�?| [cite_start]**结构输出**：交付利益相关方链、叙事杠杆与认识论缺�?[cite: 13] |
| **AI 幻觉**：无法追溯结论来�?| [cite_start]**锚点原文**：所有裁定均强制关联原文证据 [cite: 556] |
| **决策滞后**：难以快速识别风�?| [cite_start]**暗影卷宗**：深度解构隐藏契约与博弈逻辑 [cite: 558] |
...
### 1. Secure Gate 指挥�?
[cite_start]粘贴即拦截。支�?**CN / EN** 双语切换，顶层感�?**COMMANDER_ACTIVE** 引擎状态，实现毫秒级叙事捕�?[cite: 158]�?

### 2. Intel Signature (情报体征)
[cite_start]基于四维雷达图（叙事杠杆、利益张力、行动压力、可验证性）进行对抗式素描，自动生成高管级“一页纸研判�?[cite: 1246, 1249]�?

### 3. 暗影卷宗 (Shadow Dossier)
[cite_start]引入麦肯�?MECE、杜邦分析及博弈论模型。对原文进行“剥洋葱”式的逻辑展开，注�?20-30 个深度注脚揭露底层机�?[cite: 540, 558]�?

### 4. Pro Terminal (深度审讯终端)
[cite_start]在已确认的硬事实之上，使用指令式追问继续“审讯”。系统注入“华尔街做空机构”人格，粉碎一切“向好”幻�?[cite: 525, 526]�?
...
- [cite_start]**交互/状�?*: [React 19](https://react.dev/), [Framer Motion](https://www.framer.com/motion/) [cite: 14, 60]
...
- [cite_start]**导出服务**: [Playwright](https://playwright.dev/) (用于高精�?PDF 渲染) [cite: 664, 1758]
...
| `INGEST_TOKEN` | [cite_start]机器�?脚本调用的鉴权令�?[cite: 19] |
