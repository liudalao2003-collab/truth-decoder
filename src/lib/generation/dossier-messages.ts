...
/**
 * 核心业务：暗影卷宗提示词与消息链构建（与 V9.x API 版保持字节级一致）。
 * Worker 与历史文档共用，避免双份漂移。
 */
export interface BuildDossierMessagesResult {
...
export function buildDossierMessages(
  ...
  rawRetry: number | undefined
): BuildDossierMessagesResult {
